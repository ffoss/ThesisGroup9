# -*- coding: utf-8 -*-
"""
Created on Mon Dec 30 20:49:10 2019
...
filename = 'E:\\4.1\\thesisGroup9\\NISHATPU\\GoogleNews-vectors-negative300.bin'
...
class Data:
	...
	def getfeature(self, tweet):
		...
		swearwords = []
		with open('E:\\4.1\\thesisGroup9\\NISHATPU\\Dataset\\badwords.txt', 'r') as f:
			for line in f:
...
path = 'E:\\4.1\\thesisGroup9\\NISHATPU\\Dataset\\semeval2017-task8-dataset\\rumoureval-data'
...
with open('E:\\4.1\\thesisGroup9\\NISHATPU\\Dataset\\las_vegas_shootout.json') as f:
	line = f.readline()
	t_d= {}
	while line:
...
with open('E:\\4.1\\thesisGroup9\\NISHATPU\\Dataset\\tweets_california_shootout.json') as f:
	line = f.readline()
	t_d= {}
	while line:
		temp_t = json.loads(line.strip())
...
#%%
print("done3")
#duta loop, feature vector extract korbo tweet theke, x data 
#finding feature vector for each tweet

X_data = {}
for i in data:
	for j in i:
		X_data = {**X_data, **j.extract_features()}
print("doneXdata")
        
#%%
        
X_label = {}
path = 'E:\\4.1\\thesisGroup9\\NISHATPU\\Dataset\\semeval2017-task8-dataset\\traindev\\rumoureval-subtaskA-train.json'
with open(path) as f:
	X_label = json.load(f)
    
#%%
with open('E:\\4.1\\thesisGroup9\\NISHATPU\\Dataset\\newdata.csv', encoding='utf-8') as csv_file:
...
path = 'E:\\4.1\\thesisGroup9\\NISHATPU\\Dataset\\semeval2017-task8-test-data\\'
fold = os.listdir(path)
test_data = []
...
Y_data = {}
for i in test_data:
	Y_data = {**Y_data, **i.extract_features()}
    
#%%
Y_label = {}
path = 'E:\\4.1\\thesisGroup9\\NISHATPU\\Dataset\\test_label.json'
with open(path) as f:
	Y_label = json.load(f)
